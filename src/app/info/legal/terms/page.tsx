...
export default function Terms() {
	...
	return (
	  	<>
			{isLargeScreen ? <CoreNormalAppbar navdrawerOpener={toggleNavDrawer} title="Terms and Conditions" /> : <CoreSearchbarAppbar title="Terms and Conditions" />}
			...
			<Container hasNavbar={false} hasSearchbarAppbar navDrawerOpen={isNavDrawerOpen}>
                ...
                <List heading="Looking for something?" sectionClassName={styles.ql_list} >
					...
					<Link padded href="/info/legal/policy">Privacy Policy</Link>
